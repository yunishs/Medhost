		...
		<div class="navcontainer">
			<nav class="nav">
				<div class="nav-upper-options">
					<div class="nav-option option1" onclick="document.getElementById('if1').src = 'doc_registration.html'">
						<img src=
"https://media.geeksforgeeks.org/wp-content/uploads/20221210182148/Untitled-design-(29).png"
					...
					<div class="option2 nav-option" onclick="document.getElementById('if1').src = 'frontdesk.html'">
						<img src=
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183322/9.png"
					...
					<div class="nav-option option3" onclick="document.getElementById('if1').src = 'pat_view.html'">
						<img src=
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183320/5.png"
					...
					<div class="nav-option option4" onclick="document.getElementById('if1').src = 'medicalstaff_reg.html'">
						<img src=
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183321/6.png"
					...
					<div class="nav-option logout" onclick="document.location='loginpage.html'">
						<img src=
