  ...
  <!-- <header>
    ...
    <section class="container">
      ...
      <div class="column" >
        ...
        <?php 
                if (isset($pat_type) && $pat_type=="inpatient")
                {
                    echo '<div class="column">
                    <div class="input-box">
                        <label>Date of Admission</label>
                        <input type="datetime-local" id="date_of_admission" name="date_of_admission" value="'.$date_of_admission.'">
                    </div>
                    <div class="input-box">
                        <label>Date of Discharge</label>
                        <input type="datetime-local" id="discharge_date" placeholder="Optional" name="discharge_date" value="'.$discharge_date.'">
                    </div>
                </div>
                <div class="column">
                        <div class="input-box">
                ...
                if (isset($pat_type) && $pat_type=="outpatient")
                {   
                    echo ' <div class="column">
                    <div class="input-box">
                        <label>Date of Appointment</label>
                        <input type="datetime-local" id="date_of_visit" name="date_of_visit" value="'.$date_of_visit.'">
                    </div>
                    <div class="input-box">
                        <label>Date of Visit</label>
                        <input type="datetime-local" id="next_date_of_visit" placeholder="Optional" name="next_date_of_visit" value="'.$next_date_of_visit.'">
                    </div>
                </div>';
                }
            ?>
