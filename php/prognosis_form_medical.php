    ...
    <section class="container">
        <form class="form" method="POST">
            ...
            <div class="input-box">
                ...
                <textarea type="text" class="bp" id="bp" name="bp" placeholder="Enter the bp.." value="<?php echo $bp; ?>"></textarea>
            </div>
            <div class="input-box">
                <label>Sugar Level</label><br>
                <textarea type="text" class="sugar_level" id="sugar_level" name="sugar_level" placeholder="Enter the sugar level.." value="<?php echo $sugar_level; ?>"></textarea>
            </div>

            <div class="input-box">
                <label>Heart Rate</label><br>
                <textarea type="text" class="heart_rate" id="heart_rate" name="heart_rate" placeholder="Enter the heart_rate.." value="<?php echo $heart_rate; ?>"></textarea>
            </div>
            <div class="input-box">
                <label>SPO2</label><br>
                <textarea type="text" class="spo2" id="spo2" name="spo2" placeholder="Enter the spo2.." value="<?php echo $spo2; ?>"></textarea>
            </div>
            <div class="input-box">
