<?php
    ...
    if(isset($_POST['enter']))
    {
            ...
            if($count==1)
            {
                ...
                header('Location:dashboard_patinfo_medicalstaff_prognosis.php');
            }
            else
            {
                echo '<script>
                    window.location.href="searchpatient_medicalstaff_prognosis.php";
...
<body>
    ...
    <div class="container">
        ...
        <form action="searchpatient_medicalstaff_prognosis.php" method="POST">
             <div class="row">
                <div class="col-25">
