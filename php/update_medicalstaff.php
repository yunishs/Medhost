<?php
    ...
    $id=$_GET['updateid'];
    $sql="SELECT * from medicalstaff_info WHERE mid=$id";
    ...
    if(isset($_POST['enter']))
    {
        ...
        {
            $sql="UPDATE medicalstaff_info SET mid=$id,fname='$fname',mname='$mname',lname='$lname',reg_id='$reg_id',gender='$gender',age='$age',contact='$contact',email='$email',password='$password' WHERE mid=$id";
            $result=mysqli_query($con,$sql);
            if($result){
