...
<body>
	<header>
        <div class="logosec">
            <a href="dashboard_medical.php">
               ...
               class="icn menuicn"
               id="menuicn"></a>
               <a href="dashboard_medical.php" style="text-decoration:none;"><div class="logo">MedHost</div></a>
            <div class="logout">
	...
	<br>
	<<form  action="pat_view_medical.php" method="POST">
        <div class="top">
				...
				if($count>=1)
				{
					if($result1)
					{
						while($row1=mysqli_fetch_assoc($result1)){
							...
							<td>$email</td>
							<td>
								<button class='button1'><a href='dashboard_patinfo_medicalstaff.php?searchid=$id' class='link1'>View</a></button>
								<button class='button2'><a href='update_pat_medicalstaff.php?updateid=$id' class='link2'>Update</a></button>
								<button class='button3'><a href='delete_patient_medicalstaff.php?deleteid=$id' class='link3'>Delete</a></button>
							</td>
							</tr>";
						}
					}
					...
					echo"<script>
        			window.location.href='pat_view_medical.php';
