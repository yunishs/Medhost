		...
		<tbody>
			...
			if($result)
			{
					...
					echo '<tr>
                        ...
                        <td>'.$frequency.'</td>
					    <td>
					        <button class="button1"><a href="update_medication_medical.php?updateid='.$med_id.'" class="link1">Update</a></button>
					        <button class="button2"><a href="delete_medication_medical.php?deleteid='.$med_id.'" class="link2">Delete</a></button>
					    </td>
					</tr>';
				}
			}	
